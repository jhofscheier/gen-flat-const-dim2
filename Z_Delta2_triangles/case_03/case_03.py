"""Generalised flatness constants: a framework applied in dimension 2
   ...
   This code can be used to reproduce the computations of case 3 of
...
print(join_pretty(["width_{e_1^*-e_2^*}(P) = ",
                   sp.pretty(sp.simplify((Y-X)[0]-(Y-X)[1]))])+"\n")

# using polymake and Mathematica we get:
# max_width = 10/3
# parameters (l,m,n)=(2/5,4/5,3/5)
X = X.subs({l: 2/5, m: 4/5, n: 3/5})
Y = Y.subs({l: 2/5, m: 4/5, n: 3/5})
Z = Z.subs({l: 2/5, m: 4/5, n: 3/5})
